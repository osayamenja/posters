...
%        \vspace{0.25em}
    ...
    }
    {
        ...
        \headerbox{Background}{name=prelim,span=1,column=0}{
            ...
            \captionof{figure}{
                \footnotesize{DMoE~\cite{lepikhin2021gshard} with $W = EP = 2$.
        ...
        \headerbox{Challenges}{name=challenges,span=2,column=1}{
            The widely-adopted~\cite{geminiteam2024gemini} MoE architecture, promising \textbf{5x} faster training and
        ...
        \headerbox{Method}{name=method,span=2,column=0, below=prelim}{
            \begin{center}
                \includegraphics[width=14.55cm,keepaspectratio]{figures/aristos_arch}
            \end{center}
        }
        ...
        \headerbox{Ongoing Work}{name=future,span=1,column=2, aligned=method}{
            ...
            Equation~\ref{eqn:objective} formulates the heart of challenge \#3: finding
        ...
        \headerbox{Microbenchmarks}{name=micro,span=2,column=0, below=method}{
            \begin{center}
                \includegraphics[width=15cm,keepaspectratio]{figures/nvsh_nccl}
            \end{center}
        }
